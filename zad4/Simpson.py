...
#     for i in range(1, dividing_poins_amount + 1):
#         x_of_dividing_point = x_start + i * distance_between_points
#         integral_value_between_points += functions.choose_function(
#             x_of_dividing_point - distance_between_points / 2, choice)
#         if i < dividing_poins_amount:
#             integral_value = integral_value + functions.choose_function(x_of_dividing_point, choice)
#     integral_value = distance_between_points / 6 * (
